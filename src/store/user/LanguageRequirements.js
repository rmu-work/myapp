...
const actions = {
    ...
    LANGUAGE_REQUIREMENT_LIST({ commit }, value) {
    ...
    LANGUAGE_REQUIREMENT_POST({commit}, options) {
        let payload = null;
        if (options.formdata) {
    ...
    LANGUAGE_REQUIREMENT_DELETE({ commit }, options) {
        return new Promise((resolve, reject) => {
...
export const LanguageRequirementStore = {
    namespaced: true,
    state,
    getters,
    actions,
