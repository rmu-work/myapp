        ...
        <v-card v-if="formType !== 'DELETE'">
            ...
            <v-card-text>
                <v-form ref="form" v-model="form">
                    <v-text-field label="Document" v-model="model.name.value" :rules="model.name.rules"></v-text-field>
    ...
    methods: {
        formSubmit() {
            if (this.$refs.form.validate()) {
                this.loader = true;
                this.$store.dispatch(
                    'FinancialDocumentStore/FINANCIAL_DOCUMENT_POST',
                    {
        ...
        deleteSubmit() {
            this.loader = true;
            this.$store.dispatch(
                'FinancialDocumentStore/FINANCIAL_DOCUMENT_DELETE',
                {
                    custom_action: this.postUrl,
                }
            ).then(data => {
